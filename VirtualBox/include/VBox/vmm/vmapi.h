...
VMMDECL(int)
VMR3PhysSimpleReadGCPtr(PVMCPUCC pVCpu, void *pvDst, RTGCPTR GCPtrSrc, size_t cb);
VMMDECL(int)
VMR3PhysSimpleWriteGCPtr(PVMCPUCC pVCpu, RTGCPTR GCPtrDst, const void *pvSrc, size_t cb);
VMMR3DECL(uint32_t)
VMR3GetCPUCount(PUVM pUVM);
VMMR3DECL(bool)
VMR3GetAttached(PUVM pUVM);
VMMDECL(int)
VMR3PhysGCPtr2GCPhys(PVMCPUCC pVCpu, RTGCPTR GCPtr, PRTGCPHYS pGCPhys);
